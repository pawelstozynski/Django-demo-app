...
urlpatterns = [
    ...
    path('article/<int:article_id>/comment/', article_views.article_comment, name='article-comment'),
    path('article/<int:article_id>/comment<int:comment_id>/delete/', article_views.article_comment_delete, name='article-comment-delete'),
